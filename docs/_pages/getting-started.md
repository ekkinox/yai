...
You can find the list of [supported models here](https://platform.openai.com/docs/models/model-endpoint-compatibility) (compatible with OpenAI API `v1/chat/completions`).
